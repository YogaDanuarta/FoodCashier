                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayoutsMaster" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-static.html">Master Stock</a>
                                <a class="nav-link" href="layout-sidenav-light.html">Master User</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="layout-static.html">Transaction</a>
